...
public class ConversorTemperatura {
    ...
    functionTemperatura valorTemperatura = new functionTemperatura();
    ...
    public void conversion(String medidaElegida, String medidaToConvertir, String conversionElegida, double valorGeneral) {
        ...
        valorTemperatura.setMedida(medidaToConvertir, totalConvertido);//medida de conversorTemperatura.temperatura convertida
    ...
    public void conversionTemperatura() {
        ...
        int option = JOptionPane.showConfirmDialog(null, message, "Conversión de conversorTemperatura.temperatura", JOptionPane.OK_CANCEL_OPTION);
